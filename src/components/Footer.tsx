  ...
  return (
    <footer className="w-full bg-[#f7f6f3] py-12 sm:py-14 md:py-16 px-4 sm:px-6 border-t border-[rgba(55,53,47,0.09)]">
      <div className="max-w-7xl mx-auto text-center">
        ...
        <p className="text-sm text-[#787774] px-2 max-w-xl mx-auto mb-3 leading-relaxed">
          Startup feedback, reviews, and gallery for Bangladesh and global
          founders: SANDBOX by FluvoSoft.
        </p>
